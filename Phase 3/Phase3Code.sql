...
INSERT INTO faculty (staffID, title, stat, tenured)
VALUES (0445678, "AssociateProfessor", "Inactive", "n");

INSERT INTO faculty (staffID, title, stat, tenured)
VALUES (0468994, "Instructor", "Inactive", "n");
...
INSERT INTO staff (staffID, staffFirstName, staffLastName, staffPhoneNumber, salary, dateHired, position)
VALUES (0458894, "Lex", "Long", 2035845948, 75000, 01222010, "Secretary");

INSERT INTO staff (staffID, staffFirstName, staffLastName, staffPhoneNumber, salary, dateHired, position)
VALUES (0468994, "Racquel", "Hollis", 2055875148, 65000, 10222015, "Secretary");

INSERT INTO staff (staffID, staffFirstName, staffLastName, staffPhoneNumber, salary, dateHired, position)
VALUES (0468994, "Marju", "Danni", 2059895178, 80500, 07252017, "Professor");

#Added because there is overlap between staff and faculty
ALTER TABLE staff
ADD dateOfBirth datetime(8);

UPDATE staff 
SET dateOfBirth = 01/22/1989
WHERE staffID = 0216659;

UPDATE staff 
SET dateOfBirth = 03/06/1999
WHERE staffID = 0326598;

UPDATE staff 
SET dateOfBirth = 08/15/1966
WHERE staffID = 0458894;

UPDATE staff 
SET dateOfBirth = 11/08/1987
WHERE staffID = 0468994;

UPDATE staff 
SET dateOfBirth = 12/07/1974
WHERE staffID = 0468994;
...
INSERT INTO departments (departmentID, deptName, deptChair)
VALUES (60000000, "Chemistry", "MarjuDanni");
...
INSERT INTO falcultyClasses (staffID, classID, subjectID)
VALUES (0468994, 61521226, 61900000);
...
INSERT INTO staff (staffID, staffFirstName, staffLastName, staffPhoneNumber, salary, dateHired, position)
VALUES (0468994, "Marju", "Danni", 2059895178, 80500, 07252017, "Instructor");
...
VALUES (0216659, 0835561, "Activ", 0.000);
