...
VALUES("ASTR1265", 5648, "Study of the universe", 10000000);

INSERT INTO categories(categoryID, subjectID, categoryDescription, departmentID)
VALUES("MEDI2294", 6689, "Substance preparation to treat disease", 20000000);
...
UPDATE categories
SET subjectID = CAST('MED' as char)
WHERE categoryID = 'MEDI2294';
INSERT INTO categories(categoryID, subjectID, categoryDescription, departmentID)
...
VALUES (1945, "Astronomy Building", 5, "y", "y");

INSERT INTO building(buildingCode, buildingName, numberOfFloors, elevatorAccess, siteParkingAvailable)
VALUES (2234, "Medicine Building", 3, "y", "y");

ALTER TABLE building 
MODIFY buildingCode char(6);

UPDATE building 
SET buildingCode = CAST('1945-A' as char)
WHERE buildingName = 'Astronomy Building';

UPDATE building 
SET buildignCode = CAST('2234-B' as char)
WHERE buildingName = 'Medicine Building';
