...
class Employees:
    ...
    def __init__(self, window):
        ...
        self.back_img = Image.open('diary.jpg')
        ...
        self.heading = Label(self.left, text ="Edit Staff Information",
                             font=('arial 35 bold italic'), fg = 'HotPink4',
                             bg = "white")
        self.heading.place(x = 300, y = 0)

        self.heading = Label(self.left, text ="Staff ID",
                             font=('arial 10 bold'), fg = 'black',
                             bg = "white")
        self.heading.place(x = 0, y = 100)

        self.heading = Label(self.left, text ="Staff First Name",
                             font=('arial 10 bold'), fg = 'black',
                             bg = "white")
        self.heading.place(x = 0, y = 140)

        self.heading = Label(self.left, text ="Staff Last Name",
                             font=('arial 10 bold'), fg = 'black',
                             bg = "white")
        self.heading.place(x = 0, y = 180)

        self.heading = Label(self.left, text ="Ph no",
                             font=('arial 10 bold'), fg = 'black',
                             bg = "white")
        self.heading.place(x = 0, y = 220)

        self.heading = Label(self.left, text ="Salary",
                             font=('arial 10 bold'), fg = 'black',
                             bg = "white")
        self.heading.place(x = 0, y = 260)

        self.heading = Label(self.left, text ="Date Hired",font=('arial 10 bold'), fg = 'black',bg = "white")
        self.heading.place(x = 0, y = 300)
        self.heading = Label(self.left, text ="position",font=('arial 10 bold'), fg = 'black',bg = "white")
        ...
        # Submit Button
        self.submit = Button(self.left, text = "Add Staff Member", width = 15, height = 2, font=('arial 10 bold'),bg = "light gray", command = self.add_staff)
        self.submit.place(x=100, y = 400)
        # Search Button
        self.search = Button(self.left, text = "Click to search", width = 15, height = 2, font=('arial 10 bold'),bg = "light gray", command = self.searchstaff)
    ...
    def add_staff(self):
        ...
        self.val1 = self.staffID.get()
        self.val2 = self.staffFirstName.get()
        self.val3 = self.staffLastName.get()
        self.val4 = self.staffPhoneNumber.get()
        self.val5 = self.salary.get()
        self.val6 = self.dateHired.get()
        self.val7 = self.position.get()
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 =='' or self.val4 =='' or self.val5 =='' or self.val6 =='' or self.val7 =='':
            ...
            query = "INSERT INTO staff(staffID, staffFirstName, staffLastName , staffPhoneNumber , salary , dateHired , position ) values(%s, %s, %s, %s, %s, %s, %s) "
    ...
    def searchstaff(self):
        ...
        self.search_staff = Tk()
        self.search_staff.title("Search Employees")
        self.search_staff.geometry("1600x1000")
        self.search_label = Label(self.search_staff, text = "Employee Last Name",font=('arial 10 bold'))
        self.search_label.place(x = 0, y = 50)
        self.drop = ttk.Combobox(self.search_staff, value = ["Last Name", "First Name", "Employee ID","Dsgn ID", "Loc ID"])
        self.drop.current(0)
        self.drop.place(x = 0, y = 50)
        self.search_box = Entry(self.search_staff)
        self.search_box.place(x = 150, y = 50)
        # Search button
        self.search_now = Button(self.search_staff, text = "Search Employee", width = 15, height = 2,font=('arial 10 bold'),bg = "light gray", command = self.searchNow)
        self.search_now.place(x = 100, y = 100)
        #close button
        self.exit_now = Button(self.search_staff, text = "Close", width = 15, height = 2,font=('arial 10 bold'),bg = "light gray", command = self.search_.destroy)
        self.exit_now.place(x = 250, y = 100)
        #Edit button
        self.edit_now = Button(self.search_staff, text = "Change", width = 15, height = 2,font=('arial 10 bold'),bg = "light gray", command = self.editNow)
        self.edit_now.place(x = 400, y = 100)
        #Clear button
        self.clear_now = Button(self.search_staff, text ="Clear", width = 15, height = 2,font=('arial 10 bold'),bg = "light gray", command = self.clear)
    ...
    def searchNow(self):
        ...
        if selected == "Staff ID":
            sql_query = "SELECT * FROM staff WHERE staffID=%s"
        elif selected == "Staff First Name":
            sql_query = "SELECT * FROM staff WHERE staffFirstName=%s"
        elif selected == "Staff Last Name":
            sql_query = "SELECT * FROM staff WHERE staffLastName=%s"
        elif selected == "Ph no":
            sql_query = "SELECT * FROM staff WHERE staffPhoneNumber=%s"
        elif selected == "Salary":
            sql_query = "SELECT * FROM staff WHERE salary=%s"
