...
class Location():
    ...
    def __init__(self, window):
        ...
        self.back_img = Image.open('categories.jpg')
        ...
        self.heading = Label(self.left, text ="Category ID", font=('arial 30 bold'), fg = 'HotPink4', bg = "white")
        self.heading.place(x = 200, y = 0)

        self.heading = Label(self.left, text ="Subject ID", font=('arial 10 bold'), fg = 'black',bg = "white")
        self.heading.place(x = 0, y = 100)

        self.heading = Label(self.left, text ="Category Description", font=('arial 10 bold'), fg = 'black', bg = "white")
        self.heading.place(x = 0, y = 140)

        self.heading = Label(self.left, text ="Department ID", font=('arial 10 bold'), fg = 'black', bg = "white")
    ...
    def add_location(self):
        ...
        self.val1 = self.categoryID.get()
        self.val2 = self.subjectID.get()
        self.val3 = self.categoryDescription.get()
        self.val4 = self.departmentID.get()

        if self.val1 == '' or self.val2 == '' or self.val3 =='' or self.val4 =='' :
            tkinter.messagebox.showinfo("Error", "Fill in all fields")
        else:
            query_loc = "INSERT INTO categories(categoryID , subjectID, categoryDescription , departmentID) values(%s, %s, %s, %s) "
